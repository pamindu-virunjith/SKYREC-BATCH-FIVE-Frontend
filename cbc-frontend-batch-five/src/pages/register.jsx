...
function Register() {
  ...
  return (
    <div className='w-full h-screen bg-[url("/login.jpg")] bg-center bg-cover flex justify-center items-center'>
      ...
      <div className="md:w-[50%] h-[300px] flex justify-center items-center">
        <div className='w-[300px] md:w-[500px] h-[400px] md:h-[550px] backdrop-blur-sm rounded-[30px] shadow-xl flex flex-col justify-center items-center'>
          <input onChange={(e) => { setFirstName(e.target.value) }} value={firstName} type="text" className='border-b-3 border-white text-xl md:text-2xl m-[10px] p-[5px] focus:outline-none' placeholder='First Name' />
          <input onChange={(e) => { setLastName(e.target.value) }} value={lastName} type="text" className='border-b-3 border-white text-xl md:text-2xl m-[10px] p-[5px] focus:outline-none' placeholder='Last Name' />
          <input onChange={(e) => { setEmail(e.target.value) }} value={email} type="email" className='border-b-3 border-white text-xl md:text-2xl m-[10px] p-[5px] focus:outline-none' placeholder='Email' />
          <input onChange={(e) => { setPassword(e.target.value) }} value={password} type="password" className='border-b-3 border-white text-xl md:text-2xl m-[10px] p-[5px] focus:outline-none' placeholder='Password' />
